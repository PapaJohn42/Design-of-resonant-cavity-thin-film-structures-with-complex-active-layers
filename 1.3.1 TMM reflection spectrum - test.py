...
arr = []
f = open('Refractive Index data/TiO2.data', 'r', encoding='utf-8-sig')
next(f)
for line in f:
...
arr = []	#reset array
f = open('Refractive Index data/cVO2.data', 'r', encoding='utf-8-sig')
next(f)
for line in f:
	arr.append(map(float, line.split()))
rC = list(zip(*arr))
...
plt.title("Fig.7. coldVO2 with N=4 M=3. \n \
