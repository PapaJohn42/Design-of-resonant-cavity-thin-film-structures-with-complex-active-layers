""" 
Fig.5. Contour of the "[H/2 U4] [nC nD nC] [U1 H/2]" cavity structure
at the resonance wavelength using refractive index of nH = 2.5, nL = 1.5
nC = 2.5 - j0.25, and nD = 2.5
"""
...
q2D = 0.8	#starting estimate [input]
