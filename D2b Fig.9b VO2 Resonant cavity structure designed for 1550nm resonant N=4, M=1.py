""" 
Fig.9b Resonant cavity structure with N = 3 and M = 2 designed for resonance at 1550 nm 
...
plt.title("Resonant cavity structure with N = 3 & M = 2 designed for 1550 nm resonance.\n"
