""" 
Fig.9b Resonant cavity structure with N = 4 and M = 1 designed for resonance at 1550 nm 
...
nfc = np.concatenate((nTiO2, nTiO2,nSiO2,nTiO2, nTiO2,nSiO2,nTiO2, nTiO2,nSiO2,nTiO2, nTiO2,nSiO2,nTiO2,\
	ncVO2,nTiO2,ncVO2,\
	nTiO2,nSiO2,nTiO2, nTiO2)) # Join a sequence of arrays along an existing axis
...
thk = np.array([tTiO2/2, tTiO2/2,tSiO2,tTiO2/2, tTiO2/2,tSiO2,tTiO2/2, tTiO2/2,tSiO2,tTiO2/2, tTiO2/2,tSiO2,tTiO2/2,\
	135.87,205.21,135.87,\
	tTiO2/2,tSiO2,tTiO2/2, tTiO2/2])	# Thickness of each layer (in nm)
...
plt.title("Resonant cavity structure with N = 4 & M = 1 designed for 1550 nm resonance.\n"
