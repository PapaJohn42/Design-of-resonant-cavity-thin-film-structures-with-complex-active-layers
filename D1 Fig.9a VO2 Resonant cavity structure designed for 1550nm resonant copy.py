...
nfc = np.concatenate((nTiO2, nTiO2,nSiO2,nTiO2, nTiO2,nSiO2,nTiO2, nTiO2,nSiO2,nTiO2,\
	ncVO2,nTiO2,ncVO2,\
	nTiO2,nSiO2,nTiO2, nTiO2,nSiO2,nTiO2, nTiO2)) # Join a sequence of arrays along an existing axis
nfh = np.concatenate((nTiO2, nTiO2,nSiO2,nTiO2, nTiO2,nSiO2,nTiO2, nTiO2,nSiO2,nTiO2,\
	nhVO2,nTiO2,nhVO2,\
	nTiO2,nSiO2,nTiO2, nTiO2,nSiO2,nTiO2, nTiO2)) # Join a sequence of arrays along an existing axis
wl = 1550.0	#reference wavelength
tTiO2 = wl/(4*2.2899) # Quarterwave thick
tSiO2 = wl/(4*1.4657) # Quarterwave thick
thk = np.array([tTiO2/2, tTiO2/2,tSiO2,tTiO2/2, tTiO2/2,tSiO2,tTiO2/2, tTiO2/2,tSiO2,tTiO2/2,\
	4.92,155.39,4.92,\
	tTiO2/2,tSiO2,tTiO2/2, tTiO2/2,tSiO2,tTiO2/2, tTiO2/2])	# Thickness of each layer (in nm)
...
plt.plot(wavelengths, Ac, color="purple", label="cold VO2")
plt.plot(wavelengths, Ah, color="green", label="hot VO2", linestyle="dashed")
...
plt.title("Resonant cavity structure with N = 3 and M = 2 designed for\n"
	"resonance at 1550 nm. Comparison between cold and hot VO2 state.", fontsize=12)
