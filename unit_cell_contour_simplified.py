...
##  Simplified version, resault might be different from 'unit_cell_contour'
import numpy as np
from contour import contour

def unit_cell_contour_simplified(ns, n1, n2, N, wl, npts):   #n1=outer film index, n2=cetral film index
